...
export default function About({}: Props) {
  return (
    <motion.div
      ...
      className='flex flex-col pt-20 sm:pt-0 relative h-screen text-center w-[100%] md:w-[70%] md:text-left lg:flex-row max-w-7xl px-10 mx-auto justify-start sm:justify-evenly items-center'
    >
      ...
      <div>
        ...
        <motion.img
          ...
          className="mt-16 mx-auto flex-shrink-0 w-48 h-48 sm:w-60 sm:h-60 rounded-full object-cover md:rounded-lg md:w-64 md:h-64 xl:h-[300px] xl:w-[250px] 2xl:h-[600px] 2xl:w-[500px] borderBlur"
          />
          </div>
