...
export default function About({}: Props) {
  return (
    <motion.div
      ...
      className='flex flex-col pt-20 sm:pt-0 relative h-screen text-center w-[100%] md:w-[80%] md:text-left max-w-7xl px-10 mx-auto justify-start sm:justify-evenly items-center'
    >
      ...
      <div className='flex flex-col md:flex-row mt-16 md:mt-0 '>
        ...
        <div className='px-0 md:px-10 my-auto'>
          <h4 className='mb-2 max-[300px]:text-lg text-2xl sm:text-3xl xl:text-5xl font-semibold'>Hey, my name's Nico</h4>
