...
export default function ModalThing({}: Props) {
  return (
    <>
      ...
      <div
        data-te-modal-init
        className="fixed left-0 top-[100px] p-10 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
        id="exampleModal"
        tab-index="-1"
